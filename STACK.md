...
**① Google + Apps Script**
- ✅ ฟรีจริง เริ่มเป็นชั่วโมง · ไม่ต้องดูแลเซิร์ฟเวอร์ · เจ้าของเปิด Sheet ดูเองได้ · เหมาะมือใหม่
- ⚠️ ช้าเมื่อข้อมูลเยอะ · มีโควต้า · ไม่เหมาะคนใช้พร้อมกันเยอะ · ความปลอดภัย/UI พื้นฐาน

**② Cloudflare + Supabase**
- ✅ เร็ว+สเกลได้ · Postgres+RLS แยกข้อมูลตามลูกค้า · auth/realtime/vector สำเร็จรูป · ฟรี tier ใจดี
- ⚠️ ตั้งค่าซับซ้อนกว่า · พึ่ง 2 เจ้า (2 บิล/2 แดชบอร์ด) · Supabase free pause ถ้าไม่ใช้นาน
